    ...
    if results is not None:
        ...
        for mask in results[0].masks:
            ...
            if corner_points:
                ...
                path = [res, 'null' if res == -1 else f'{save_dir}/result{num}.jpg']
                ress.append(path)
                if res == -1:
                ...
                # plt.show()
                num = num + 1
        visualize_masks_on_image('./segment/res/mask_image.jpg', image, masks, colors)
    return ress
